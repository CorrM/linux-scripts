...
# For NVidia Install cachyOS kernel with that video https://www.youtube.com/watch?v=_FqQ8MCWFlU,
# then use that video to install GPU drivers https://www.youtube.com/watch?v=0tu1-M_qJos
